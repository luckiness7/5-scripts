...
from doubleRegMaSignal import maSignal

########################################################################
# 策略继承CtaTemplate
class DoubleRegMaStrategy(CtaTemplate):
    """线性回归均线策略Demo"""
    className = 'DoubleRegMaStrategy'
    author = 'ZHANGJIE'
    ...
    def __init__(self, ctaEngine, setting):
        ...
        # 设置初始变量
        self.transactionPrice = None  #记录成交价格
    ...
    def strategy(self, bar):
        ...
        #array2, amSignal = self.arrayPrepared(signalPeriod)
        #trend = maSignal()
        #filterCanTrade = trend.filterLowAtr(amSignal, self.paraDict)
